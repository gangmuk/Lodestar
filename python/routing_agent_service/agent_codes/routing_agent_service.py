...
def handle_infer():
    ...
    try:
        ...
        if subAlgorithm == 'latency_predictor':
            import unused_models.latency_predictor as latency_predictor
        ...
        if model_type == 'latency_predictor':
            ...
            if REPLAY_SIZE > 0:
                try:
                    ...
                    prev_agent = reward_predictor._cached_agent if NUM_TRAINS > 0 else None
            ...
            if OLD_TRANSFER_MONITOR is not None:
                try:
                    ...
                    trained_agent = reward_predictor._cached_agent
