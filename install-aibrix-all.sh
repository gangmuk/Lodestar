...
node_name=node1.gangmuk-267524.mlproxy-pg0.utah.cloudlab.us
...
kubectl apply -f ~/projects/aibrix-gangmuk/benchmarks/data-driven-routing/routing-agent-service/k8s/routing-agent/svc-routing-agent-service.yaml
...
## Mock application
cd ~/projects/aibrix-gangmuk/development/app && ./build-and-push.sh local
