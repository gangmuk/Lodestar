        ...
        for CANDIDATE_K in "${CANDIDATE_K_LIST[@]}"; do
            ...
            for experiment_idx in $(seq 0 $((num_experiments-1))); do
                ...
                if [ "${routing_policy}" == "prefix_hit_threshold_or_least_request" ]; then
                    experiment_result_output_dir="../workload-and-experiment_results/${target_gpu}/${llm_model}/${output_wrk_name}/${workload_category}/${workload_name}/rps${rps}-${workload_mode}/${vllm_config}/${subAlgorithm}_threshold_${PREFIX_HIT_THRESHOLD}"
                else
                    experiment_result_output_dir="../workload-and-experiment_results/${target_gpu}/${llm_model}/${output_wrk_name}/${workload_category}/${workload_name}/rps${rps}-${workload_mode}/${vllm_config}/${subAlgorithm}"
                fi
