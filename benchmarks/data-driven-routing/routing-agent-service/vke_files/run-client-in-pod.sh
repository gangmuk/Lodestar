...
experiment_configs=(
    ...
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_random-onlinelearning_1|gangmuk-prefix|SharingRatio71%|${target_gpu}|8|6"
    ...
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_random-onlinelearning_1|gangmuk-prefix|SharingRatio71%|${target_gpu}|4|6"

    #########################################
    ## 47%, total number of requests: 2000 ##
    #########################################
    # "prefix_cache_1|gangmuk-prefix|SharingRatio47%|${target_gpu}|8|4"
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_random-onlinelearning_1|gangmuk-prefix|SharingRatio47%|${target_gpu}|8|6"
    ...
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_random-onlinelearning_1|gangmuk-prefix|SharingRatio47%|${target_gpu}|4|6"

    #####################################################
    ## SharingRatio28%, total number of requests: 2000 ##
    #####################################################
    # "prefix_cache_1|gangmuk-prefix|SharingRatio28%|${target_gpu}|8|4"
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_random-onlinelearning_1|gangmuk-prefix|SharingRatio28%|${target_gpu}|8|6"
    # "least_request|gangmuk-prefix|SharingRatio28%|${target_gpu}|8|4"
    ...
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_random-onlinelearning_1|gangmuk-prefix|SharingRatio28%|${target_gpu}|4|6"

    #####################################################
    ## SharingRatio9%, total number of requests: 2000 ##
    #####################################################
    # "prefix_cache_1|gangmuk-prefix|SharingRatio9%|${target_gpu}|8|4"
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_random-onlinelearning_1|gangmuk-prefix|SharingRatio9%|${target_gpu}|8|6"
    # "least_request|gangmuk-prefix|SharingRatio9%|${target_gpu}|8|4"
    ...
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_random-onlinelearning_1|gangmuk-prefix|SharingRatio9%|${target_gpu}|4|6"
    ...
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_random-onlinelearning_1|gangmuk-prefix|MixedSharingRatio10_30_50_70%|${target_gpu}|8|4"
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_random-onlinelearning_1|gangmuk-prefix|MixedSharingRatio10_30_50_70%|${target_gpu}|6|4"
    ...
    # "lmetric|mooncake|toolagent-2-extended-ver1|${target_gpu}|12,8|1"
    # "contextual_bandit_perpodmodel_checkpoint_ttft_negative_linear_conversation_2-onlinelearning_0|mooncake|toolagent-2-extended-ver1|${target_gpu}|12,8|1"
    # "prefix_cache_1|mooncake|toolagent-2-extended-ver1|${target_gpu}|12,8|1"
    # "least_request|mooncake|toolagent-2-extended-ver1|${target_gpu}|12,8|1"
    # "least_prefill_tokens|mooncake|toolagent-2-extended-ver1|${target_gpu}|12,8|1"
    # "prefix_hit_threshold_or_least_request|mooncake|toolagent-2-extended-ver1|${target_gpu}|12,8|1|20"
    # "prefix_hit_threshold_or_least_request|mooncake|toolagent-2-extended-ver1|${target_gpu}|12,8|1|40"
    # "prefix_hit_threshold_or_least_request|mooncake|toolagent-2-extended-ver1|${target_gpu}|12,8|1|60"
    # "prefix_hit_threshold_or_least_request|mooncake|toolagent-2-extended-ver1|${target_gpu}|12,8|1|80"
...
# CB_RESET_LR_PER_ROUND is set by LEARNING_METHODOLOGY below
RECENCY_DECAY_WEIGHT_FACTOR=1.0
ENABLE_FALLBACK=0
INCLUDE_GPU_FEATURES=0
LOAD_PRETRAINED_MODEL=1
MAX_NUM_ONLINE_TRAINS=8  # -1=unlimited, N=stop online training after N rounds
EXPLORATION_ENABLED=1
EXPLORATION_RATE=0.1
NORMALIZATION_MODE=zscore # zscore, fixed_range
ENABLE_PREFIX_FILTERING=1
GPU_KV_SATURATION_THRESHOLD=0.5
...
AIBRIX_PREFIX_CACHE_BLOCK_NUMBER=250000
...
# learning_methodology_list=("from_scratch_fifo_replay" "from_scratch_all_data" "cl_fifo_replay" "cl_new_data_only")
learning_methodology_list=("from_scratch_fifo_replay" "from_scratch_all_data" "cl_new_data_only")
# learning_methodology_list=("from_scratch_fifo_replay")
total_runs=$(( num_experiments * ${#learning_methodology_list[@]} ))
global_idx=0
echo "========================================="
echo "Will run ${total_runs} experiment(s) (${num_experiments} configs x ${#learning_methodology_list[@]} learning methodologies):"
...
for learning_methodology in "${learning_methodology_list[@]}"; do
    ...
    #   "from_scratch_fifo_replay"    - (Config 1) Retrain from random weights each round, FIFO+Replay buffer
    #   "from_scratch_all_data"       - (Config 2) Retrain from random weights each round, keep all data (no replay)
    ...
    if [ "$learning_methodology" == "from_scratch_fifo_replay" ]; then
    ...
    elif [ "$learning_methodology" == "from_scratch_all_data" ]; then
    ...
    for experiment_idx in $(seq 0 $((num_experiments-1))); do
        ...
        if [ "${routing_policy}" == "prefix_hit_threshold_or_least_request" ]; then
            ...
            experiment_result_output_dir="../workload-and-experiment_results/${target_gpu}/${llm_model}/${output_wrk_name}/${workload_category}/${workload_name}/rps${rps}-${workload_mode}/${vllm_config}/${subAlgorithm}_${learning_methodology}-iter${total_num_episodes}"
        fi
        ...
        retry_command python3 update_k8s_env.py \
            ...
            --env ENABLE_PREFIX_FILTERING=${ENABLE_PREFIX_FILTERING} \
