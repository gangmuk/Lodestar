...
final_model_dir="../training_data/SharingRatio71%/all/final_model-data_replaced-processed-linear_simple-lr_0.001-ttft_weight_2.0-ttftslo_1000-avgtpotslo_50"

# final_model_dir="../training_data/p4096_s1024_rps20/rl+random/final_model_backup" # not working again...
# final_model_dir="../training_data/p4096_s1024_rps20/rl+random/final_model" # not working again...
# final_model_dir="../training_data/p4096_s1024_rps20/rl+random/final_model-data_replaced-processed-linear_simple-lr_0.001-ttft_weight_2.0-ttftslo_1000-avgtpotslo_50" # this is sort of working

# final_model_dir="../training_data/p4096_s1024_rps20/all/final_model-data_replaced-processed-linear_simple-lr_0.001-ttft_weight_0.5-ttftslo_1000-avgtpotslo_50" # this is working, this is better though.
# final_model_dir="../training_data/p4096_s1024_rps20/all/final_model-data_replaced-processed-linear_simple-lr_0.001-ttft_weight_1.0-ttftslo_1000-avgtpotslo_50" # this is working, this is better though.
# final_model_dir="../training_data/p4096_s1024_rps20/all/final_model-data_replaced-processed-linear_simple-lr_0.001-ttft_weight_2.0-ttftslo_1000-avgtpotslo_50" # this is working, this is better though.
# final_model_dir="../training_data/p4096_s1024_rps20/all/final_model-data_replaced-processed-linear_simple_extended-lr_0.001-ttft_weight_2.0-ttftslo_1000-avgtpotslo_50" # this is working, this is better though.
...
for workload_dir in "${input_workload_dirs[@]}"; do
    ...
    for config in "${routing_configs[@]}"; do
        ...
        ssh root@180.184.82.203 "cd /mnt/vdb/data-driven-routing/client && bash run-client-only.sh ${subAlgorithm} ${workload_dir} ${ENABLE_ONLINE_LEARNING} ${iterations} ${max_tokens}"
