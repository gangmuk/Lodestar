...
def calculate_rewards_simple_extended(ttft_values, tpot_values, ttft_slo, avg_tpot_slo):
    """
...
def calculate_rewards_piecewise_linear_steeper_gradient(ttft_values, tpot_values, ttft_slo, avg_tpot_slo):
    """
